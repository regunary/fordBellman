...
namespace WindowsFormsApp1
{
    class BellmanFord
    {
        ...
        //hàm fordbellman
        public void FordBellman(Matrix matrix, RichTextBox rtb, int x, int y, Graphics graph, Draw draw, Bitmap bm, Vertex vertex, DrawMatrix f)
        {
        ...
        //hàm vẽ đường đi
        private void move(int[] d, int[] before, int m, int n, RichTextBox rtb, Matrix matrix, Graphics graph, Draw draw, Bitmap bm, Vertex vertex, DrawMatrix f)
        {
