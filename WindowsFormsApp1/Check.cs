...
namespace WindowsFormsApp1
{
    class Check
    {
        ...
        public void DFSCheckConnection(int[] _index, int[] _notChecking, int _iconnect, int vertex, Graphics graph, Matrix matrix, Draw draw, Bitmap bm, DrawMatrix f)
        {
        ...
        public void checkingConnection(Matrix matrix, Draw draw, Graphics graph, Bitmap bm, DrawMatrix f)
        {
            for (int i = 0; i < matrix._iNMatrix; i++)
            {
